...
def predict():
    if request.method=='POST':
        ...
        return render_template('index.html',predicted_disease,dis_des=desc,dis_pre=pre,dis_med=med,dis_wrkout=wrkout)
...
#render _templates helps to deal form moving in webpage in flask
